...
A responsive and interactive extension manager app that allows users to toggle themes (light/dark), filter extensions by state (active/inactive/all), and remove extensions from the DOM in real time. Built using HTML5, modern CSS with nesting (Sass-like), and vanilla ES6 JavaScript. Auto-deployed via Vercel.
...
- Auto-deploy via Vercel on push to GitHub
...
- **GitHub** – Source control and integration with Vercel

---

## Project Structure
<pre lang="markdown"> extension-manager/
├── index.html
├── extensions.json
├── assets/
│   ├── images
...
## Deployment
This project is deployed using Vercel. Every push to the main branch triggers an automatic deployment.
